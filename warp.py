...
csv = '/Users/yang/Documents/Wilbrecht_Lab/data/testing_space/RRM027_Day155_R4_tracks_raw.csv'
output_df = warp_coordinates(csv)
output_df.to_csv('/Users/yang/Documents/Wilbrecht_Lab/data/testing_space/R4_out.csv')
